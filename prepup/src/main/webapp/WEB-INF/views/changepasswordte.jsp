...
<head>
    ...
    <title>Prep-UP || Change Password</title>
    <!-- Bootstrap Core CSS -->
...
<!--                                                 <p class="text-muted">Prep-Up</p> -->
                                    ...
                                    <li><a href="upadteprofilete"><i class="ti-settings"></i>  Update Profile</a></li>
                                    <li role="separator" class="divider"></li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class=" waves-effect waves-dark" href="teacher_dashboard" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Home </span></a>
                        </li>
                        <li> <a class=" waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-plus"></i><span class="hide-menu">Create Class </span></a>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="teacher_dashboard">Home</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <center><h4 class="m-b-0 text-white">Change Password</h4></center>
                            </div>
                            <div class="card-body">
                                <form:form action="#" class="form-horizontal">
                                    <div class="form-body">
                                          ...
                                          <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <form:input type="text" name="email" value="${userDetailsVO.emailid}" class="form-control" readonly="true" /><br>
                                                         </div>
                                                </div>
                                            </div>
                                            </div>
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <form:input type="text" name="current"  class="form-control" required="true" /><br>
                                                         </div>
                                                </div>
                                            </div>
                                            </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3 required">New Password</label>
                                                    <div class="col-md-9 controls">
                                                    <form:input type="text" name="password" id="password" required data-validation-required-message="This field is required" class="form-control" placeholder="" maxlength="30"  required="true" />
                                                         </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group  row">
                                                    <label class="control-label text-right col-md-3 required">Confirm Password</label>
                                                    <div class="col-md-9 controls">
                                                        <form:input type="text" name="password2" id="password2" class="form-control " placeholder="" maxlength="30" data-validation-match-match="password" required="true" />
                                                         </div>
                                                </div>
                                            </div>
                                            <center>
