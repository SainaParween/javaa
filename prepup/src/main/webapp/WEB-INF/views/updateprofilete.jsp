...
<!--                                                 <p class="text-muted">Prep-Up</p> -->
                                    ...
                                    <li><a href="#"><i class="ti-settings"></i>  Update Profile</a></li>
                                    <li role="separator" class="divider"></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form:form action="updateprofilete" method="post" modelAttribute="userdetails"  class="form-horizontal" role="form">
                                    <div class="form-body">
